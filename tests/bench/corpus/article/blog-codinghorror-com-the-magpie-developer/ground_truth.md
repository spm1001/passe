...
Over a year ago I unsubscribed from[Steve’s blog]because he had a habit of writing in breathless fashion about the latest shiny new thing – often several times a day. I see too many people I know getting caught up in the breathless hype andforgetting to think about whether the latest shiny new thing really matters in the grand scheme of things.
...
It isn’t just the never ending stream of tech news. It’s also the tidal push and pull of a [thousand software religious wars](https://blog.codinghorror.com/are-you-there-god-its-me-microsoft/) that continually wears us down, like errant rocks in a rapidly flowing stream. I bet [the process David Megginson outlines](https://web.archive.org/web/20080110114416/http://www.megginson.com/blogs/quoderat/2006/03/06/programming-languages-of-distinction/) sounds awfully familiar:
...
If you consider that, statistically, the vast majority of programmers have yet to experience a dynamic language of *any* kind – much less Ruby – the absurdity here is sublime. Some dynamic language features are trickling down to the bastions of Java and .NET, but slowly, and with varying levels of success. These so-called thought leaders have left a virtual ghost town before anyone else [had a chance to arrive](https://blog.codinghorror.com/fifty-years-of-software-development/).

I became a programmer because I love computers, and to love computers, [you must love change](https://blog.codinghorror.com/if-loving-computers-is-wrong-i-dont-want-to-be-right/). And I do. But I think **the magpie developer sometimes loves change to the detriment of his own craft**. Andy Hunt and Dave Thomas, the [Pragmatic Programmers](https://blog.codinghorror.com/pragmatic-programming/) who were a big part of the last sea change in Ruby, said it quite well in [a 2004 IEEE column](http://media.pragprog.com/articles/sep_04_imaginate.pdf) (pdf).
...
[Don’t feel inadequate](https://blog.codinghorror.com/keeping-up-and-just-in-time-learning/) if you aren’t lining your nest with the shiniest, newest things possible. **Who cares what technology you use**, as long as it *works*, and both you and your users are happy with it?
