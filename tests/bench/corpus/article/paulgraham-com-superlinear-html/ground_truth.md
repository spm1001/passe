...
*p* over time *t* would be proportional to *p*t.
...
threatens some vested interests and contradicts some ideologies. [[8](#f8n)]
...
as the list of fields where you have to be __independent-minded__ to
...
[[6]]
In my twenties I wanted to be an __artist__
...
advanced economies the ratio has __shifted dramatically__ toward discovery
